...
def main(start1, diffFunc, params, clr="black"):
...
if __name__ == "__main__":
    ...
    # params = np.array([0.00049056, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    # params2 = np.array([0.00049055, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    # params = np.array([0.00044, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    # params2 = np.array([0.000442, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    params = np.array([0.000529799599, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    # params = np.array([0.00052398, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    params2 = np.array([0.0005306012, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    params2 = np.array([0.000545, 0.39208, 0.2, 1], dtype=np.longdouble) # eps alpha beta p lerFRMS3  TestLyap
    
    # for i in start_point:
    #     main(i)
    clr = "red"
    main(start_point[0], diffFunc, params)
    main(start_point[0], diffFunc, params2, clr)
