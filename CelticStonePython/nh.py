...
def calc_m3_and_omega(d, I1, I2, I3, a1, a2, h, E, g0, r, gamma, m1, m2):
...
def sys(state, res, params, omega, H): # масса 1
    d = params[0]
...
if __name__ == "__main__":
    ...
    main_traj = np.array([0.5, 0.1, 0.5, 0.5]) # M1 M2 gamma1 gamma2 

    params = [0.2, 5, 6, 7, 9, 4, 1, 470, 100] # d I1 I2 I3 a1 a2 h E g0
    d = params[0]
    I1, I2, I3 = params[1], params[2], params[3]
    a1, a2 = params[4], params[5]
    h, E, g0 = params[6], params[7], params[8]
    ...
    for i in range (1000):
        ...
        m3, omega1, omega2, omega3 = calc_m3_and_omega(d, I1, I2, I3, a1, a2, h, E, g0, r, gamma, m1, m2)
        omega = np.array([omega1, omega2, omega3])
        M = np.array([m1, m2, m3])

        dverkStep(main_traj, 4, sys, params, 0.01, omega)
        x1.append(i)
        omega_y.append(main_traj[0])
    ax.plot(x1, omega_y)
    plt.show()
