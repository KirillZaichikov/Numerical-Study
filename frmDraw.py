...
params = np.array([1.04475, 0.6057, 0.2], dtype=np.longdouble) # точка 3 Лакуна 256 A = 1.0176
params = np.array([0.69, 0.61, 0.2], dtype=np.longdouble) 
params = np.array([1.04475, 0.6057, 0.2], dtype=np.longdouble) # точка 3 Лакуна 256 A = 1.0176
...
print('nu', nu)
print('mu', mu)
# print('shift_min', shift_min) # for cline is down
# print('mu_min', mu_min) # for cline is down
...
# y = abs(0.8*pow((abs(x-shift_min)), nu)+mu_min) # for cline is down
ax.plot(x, y, c='red')
