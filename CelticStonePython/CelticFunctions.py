...
def calc_vector_omega(const double* r, double* omega, const double* state, const double* params):
...
def CelticStone_6D_flow(const double* state, double* res, const double* params):
    double r[3];
    double r1, r2, r3;
    double omega[3];
