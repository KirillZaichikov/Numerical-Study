...
def main_sys(start_point, res, params, H):
    '''
    Трехмерная система ksi,phi,teta
    '''
    ro, mpar, i1, i2, a0, g, en = params
    # print(start_point)
    # print(type(start_point))
    # print(np.shape(start_point))
...
def main_sys_poincare(start_point, res, params, H):
    '''
    Трехмерная система ksi,phi,teta
    с отображением Пуанкаре методом Эно
    '''
...
def omega12_sys(start_point, res, params, H):
    '''
    тут наверное хотел сделать систему с omega1 и omega2 
    '''
    ro, mpar, i1, i2, a0, g, en = params
