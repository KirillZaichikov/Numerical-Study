...
ax_phase.set_xlabel('Ось M1', fontsize=12, labelpad=10)
ax_phase.set_ylabel('Ось M2', fontsize=12, labelpad=10)
ax_phase.set_zlabel('Ось Gamma1', fontsize=12, labelpad=10)
plt.show()
